...
namespace SimpleDataSample.POCO
{
    public class Album
    {
        ...
        public override string ToString()
        {
            var sb =
                new StringBuilder(
                    string.Format("Album. AlbumId: {0}; GenreId: {1}, ArtistId: {2}, Title: {3}, Price: {4:C}", AlbumId,
                                  GenreId, ArtistId, Title, Price));
    ...
    public class OrderDetails
    {
        ...
        public override string ToString()
        {
            var sb = new StringBuilder(
                String.Format(
                    "OrderDetail. OrderDetailId = {0}, OrderId = {1}, AlbumId = {2}, Quantity = {3}, UnitPrice = {4:C}",
